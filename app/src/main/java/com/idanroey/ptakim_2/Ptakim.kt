...
class Ptakim(filteredCategories: IntArray, private val numberOfWords: Int, private val team1: Team, private val team2: Team) {
    ...
    private val wordBank: Map<Int, List<String>>
        get() = mapOf(
            R.id.places to listOf("הוליווד","יד ושם","הגנים הבהאים","ים המלח", "הבית הלבן", "יפן", "אילת", "הקולסאום", "ישראל ", "סקוטלנד", "מאדים", "גבעת התחמושת", "כיכר רבין", "הכנרת", " ארגנטינה ", "ברצלונה", "החומה הסינית", "ירושליים", "מוזאון הלובר ", "קיסריה", " הירח", "מגדל פיזה", "רצועת עזה ", "הקריה", "מוזאון ישראל ", "הוותיקן"),
            ...
            R.id.cultureLeaders to listOf("יו 2","ארז טל","הריסון פורד","ג'ון לנון","מרלין מונרו","סטינג","שרית חדד","אלביס פרסלי","סנדרה בולוק","נטלי פורמן","ביטלס","ספייס גירלס","עמוס עוז","מדונה","ג'וליה רוברטס","פבלו פיקאסו","ג'ון לנון"," משינה ","מטאליקה ","דיוויד בואי","וויטני יוסטון","נירוונה","ג'סטין טימברלייק","טום האנקס ","אופרה ווינפרי"),
            ...
            R.id.hamisiSalof to listOf("'למה לא'","צומת חביתה","'לנצח'(להקיא)","נאד כלוא","אסף גרניט","אניני טעם","סיאסטה","ניר מהסביח","גחלת","power hour","back to school","אגנס","סלוף","לחוח","שיפרון","אינדינגב","קולסאום","דגים","שלאקות"),
        )
